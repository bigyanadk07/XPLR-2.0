...
const AboutUs = () => {
  return (
    <>
      <div className="bg-[url('./WALLPAPER/header1.jpg')] bg-cover w-screen">
        <div className="flex flex-row justify-between">
          <div className=" p-4 ml-4">
            <img src={iop} className=" h-20 w-20" />
          </div>
          <div className="flex flex-row space-x-2  m-4 mr-8">
            <Link to="/home" className="pr-5 pl-5 p-2 m-5 text-white">
              Home
            </Link>
            <Link to="/about" className="pr-5 pl-5 p-2 m-5 text-white">
              About Us
            </Link>
            <Link to="/contact" className="pr-5 pl-5 p-2 m-5 text-white">
              Contact
            </Link>
            <Link
              to="/signin"
              className=" border-2 rounded-full border-white pr-5 pl-5 p-2 m-5 text-white"
            >
              Sign in
            </Link>
          </div>
